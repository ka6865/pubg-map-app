...
export const metadata: Metadata = {
  ...
  keywords: ["배틀그라운드", "배그 지도", "BGMS", "배그 전적", "AI 전적분석", "전적 비교", "가방계산기", "가방시뮬레이션", "2D리플레이", "자기장 시뮬레이션", "배그 패치노트", "배그 고젠", "배그 고정 젠", "에란겔 고젠", "미라마 고젠", "테이고 고젠", "론도 고젠", "PUBG Map", "배그 차량 위치", "비밀의 열쇠", "에란겔 비밀의 열쇠", "미라마 비밀의 열쇠", "테이고 비밀의 열쇠", "론도 비밀의 열쇠", "배그 비밀방 위치", "에란겔 비밀방", "미라마 비밀방", "론도 비밀방", "테이고 비밀방"],
